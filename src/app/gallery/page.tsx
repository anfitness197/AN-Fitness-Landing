    ...
    <div className="relative min-h-screen bg-zinc-950 flex flex-col justify-between overflow-x-hidden text-white pt-20 sm:pt-24 pb-12 sm:pb-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 flex-1 flex flex-col gap-6 sm:gap-10">
        ...
        <div className="text-left flex flex-col gap-2 sm:gap-3">
          <span className="text-[11px] sm:text-xs text-brandRed font-mono font-black uppercase tracking-[0.3em] sm:tracking-[0.4em] bg-brandRed/10 px-3 py-1 rounded self-start">Inside the gym</span>
          <h1 className="font-heading font-black text-3xl sm:text-4xl md:text-6xl text-white uppercase tracking-tight leading-none">Gallery</h1>
          <p className="text-zinc-500 text-xs sm:text-sm md:text-base max-w-xl font-light">Browse our workout areas, training spaces, and gym facilities.</p>
        </div>
