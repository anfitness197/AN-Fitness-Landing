...
export const metadata: Metadata = {
  ...
  description:
    "Explore AN Fitness membership plans and pricing. Affordable gym memberships with full access to strength training, personal coaching, and premium facilities in Khordha.",
  openGraph: {
